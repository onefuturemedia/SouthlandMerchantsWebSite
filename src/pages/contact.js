...
import { Container, Heading, Text, Label, Input, Textarea, Box, Button, Image } from 'theme-ui';
...
export default function Contact() {
	function sendEmail(e) {
		...
		emailjs.sendForm('service_dbsaba5', 'template_hhofbmv', e.target, '_fsNrHdzcngXOtcUz').then(
			result => {
	...
	return (
		<StickyProvider>
			<Layout isHome={false}>
				...
				<Box as="section" classname="contact-us-container" sx={styles.container}>
					<Heading classname="contact-us-heading" as="h3">
						Contact Us
					</Heading>
					<Container classname="contact-us-founders-container" sx={styles.founders}>
						<Box classname="contact-us-nadia-box" sx={styles.foundersBox}>
							...
							+61 (0) 409 007 565
							<br />
							nadia@southlandmerchants.com.au <br />
						</Box>
						<Box classname="contact-us-andre-box" sx={styles.foundersBox}>
							...
							+61 (0) 452 142 412
							<br />
							andre@southlandmerchants.com.au <br />
						</Box>
					</Container>
					<Text classname="contact-us-text" as="p">
						If you would like to receive some samples or any another enquiry you can also send us a message
						here: <br />
					</Text>
					<Container classname="contact-us-form" as="form" onSubmit={e => sendEmail(e)} sx={styles.formBox}>
