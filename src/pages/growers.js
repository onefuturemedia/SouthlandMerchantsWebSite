...
import macaubasPDF from "../assets/documents/macaubas.pdf"
...
import macaubasIMG from "../assets/grower/macaubas.png"
...
const data = [
  {
    ...
    growers: [
      {
        name: "Reinaldo Rocha",
        description: "Macaubas Farm",
        img: macaubasIMG,
        documentPath: macaubasPDF,
      ...
      {
        name: "Ellen Lorencini",
        description: "Morada do Sol Farm",
        img: moradaDoSolIMG,
        documentPath: moradaDoSolPDF,
        instagramUrl: "https://www.instagram.com/southlandmerchants/",
      },
      {
        name: "Cesar Zuanetti",
